...
Cada operador possui uma página HTML independente com campos para entrada de três valores numéricos e exibição detalhada do resultado das condições avaliadas.
